...
public class StudentExample {
	public static void main(String[] args) {
		...
		list.set(0, new Student(201, "서현일", 90, 92)); //첫번째 학생정보 변경, 첫번째 인스턴스 변경
		result = list.get(0); //변경된 학생정보 다시 담기
		...
		System.out.println("첫 번째 학생 : " + list.get(0).toString()); //0이 삭제되면서 1에 있던 인스턴스가 0에 담김
	}
}
